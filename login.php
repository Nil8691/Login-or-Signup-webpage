...
<div class="nav_bar">
	...
	<div class="nav_bar_innerpart">
		...
		<div class="img">
			<img src="img/FlexJobs_logo.png" width="10%" height=10%>
		</div>
	</form>
</div>
	<div class="Signup_Form">
		<div class="main-container">
				<div class="sub-container">
					...
					<div>
						...
						<input type="text" class="signup_submit" name="username">
					</div>
					<div>
						<input type="email" class="signup_submit" name="email">
					</div>
					<div>
						<input type="password" class="signup_submit"  name="password">
					</div>
					<div >
		...
		<div class="main-container part2">
				<div class="Title">
					<h1>Follow Your Passion in Job</h1>
					<p>After College Life job is second life where our Entire Youth will spend<br/>So lets Choose Your own interesting Job for Enjoy Job life</p>
				</div>
		</div>
	</div>
	<div class="footer">
